        ...
        <div className="p-6 border-b border-slate-100 flex flex-col sm:flex-row gap-4 items-center justify-between">
          <div className="relative w-full max-w-md">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-indaia-blue outline-none transition-all"
            />
          </div>
        </div>
              ...
              <form onSubmit={handleCreateUser} className="p-6 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-indaia-blue outline-none transition-all"
                  />
                </div>
